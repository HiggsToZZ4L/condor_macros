...
void HZZ4LeptonsAnalysis::Loop(Char_t *output)
{
   ...
   */
   ...
   Int_t f_run, f_lumi, f_event, f_PU_vertices;
   ...
   TBranch *b_PU_vertices= newtree->Branch("f_PU_vertices", &f_PU_vertices, "f_PU_vertices/I");
   //
