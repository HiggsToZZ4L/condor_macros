...
void HZZ4LeptonsAnalysis::Loop(Char_t *output)
{
   ...
   */
   ...
   TBranch *b_f_PU_vertices=newtree->Branch("f_PU_verticies", &f_PU_vertices, "f_PU_vertices/I");
   float newweight=1.;
